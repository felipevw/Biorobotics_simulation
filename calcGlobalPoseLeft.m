...
function [output] = calcGlobalPoseLeft(angles, position_ref)
    ...
    r_ls = r_lf + R_ls*r_ls_lf;
    r_lt = r_ls + R_lt*r_lt_ls;
    r_t = r_lt + R_t*r_t_lt;
    r_rt = r_t + R_rt*r_rt_t;
    r_rs = r_rt + R_rs*r_rs_rt;
    r_rf = r_rs + R_rf*r_rf_rs;
    ...
    output = [r_lf, r_ls, r_lt, r_t, r_rs, r_rf, r_lfh, r_lft, r_rfh, r_rft, r_ra, r_rah, r_lah];
